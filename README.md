...
1.  **Architecture "API-First"** : Le guide télé utilise des sources de données officielles (API ESPN gratuite) comme **stricte source de vérité** pour construire la grille des matchs. Cela empêche les doublons et assure des horaires exacts.
