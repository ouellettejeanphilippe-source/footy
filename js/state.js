...
export var S = { searchQuery:'',  log:[], raw:'', matches:[], matchMap: new Map(), proxy:'', filter:'live', sportFilter:'all', hiddenLg:{}, collapsedLg:{'Autres Flux':true}, collapsedSections:{}, railSections:{} };
