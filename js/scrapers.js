...
/* Un domaine qui a sa propre forme a son propre fichier (js/sources/<domaine>.js).
       Footybite y est passé le 6 septembre 2026 : « chaque domaine doit être différent
       dans le système de fetch and parse ». Les autres suivront ; tant qu'un domaine n'a
       pas d'adaptateur, il passe par les branches ci-dessous puis par le moteur
       générique, exactement comme avant. */
    var adaptateur = adaptateurPour(pageHost);
    if (adaptateur) {
        try {
