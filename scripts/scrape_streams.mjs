...
/* Plus d'extraction de lecteurs ici depuis le 6 septembre 2026. La tuile charge la page
   du match telle que le site la sert, et le script utilisateur ne garde que la vidéo :
   c'est ce qui marche. Les lecteurs extraits en chaîne (jusqu'à trois sauts, huit minutes
   par passage) ne jouaient pas — pages intermédiaires, pages anti-adblock, hôtes morts.
   Le budget libéré va à la vérification observée (scripts/verify_players.mjs). */
