...
**Appelée par :** `parseStreameast`, `parsePWHLSchedule`, `parseSportsurge`, `parseOnHockey`, `parseBuffstreams`, `next`, `parseNflbite`, `parseMlbbite`, `parseFootybite`, `scrapeMatchFlux`, `openMod`, `getApiFirstMatches`
